  ...
  return (
    <div>
      <Jumbotron>
        ...
        <hr className="my-2" />
        <p>During my four years at Middlebury I helped captain the Men's Ultimate Frisbee Team, participated in our computer science club, MiddleEndian, and tutored students taking Data Structures and Computer Architecutre.</p>
